...
def main():
    ...
    parser.add_argument("--train_seg_x_dir", default='{}/datasets/train_set.seg_x_new.txt'.format(BASE_DIR), help="train_seg_x_dir")
    parser.add_argument("--train_seg_y_dir", default='{}/datasets/train_set.seg_y_new.txt'.format(BASE_DIR), help="train_seg_y_dir")
    parser.add_argument("--valid_seg_x_dir", default='{}/datasets/valid_set.seg_x.txt'.format(BASE_DIR), help="valid_seg_x_dir")
    parser.add_argument("--valid_seg_y_dir", default='{}/datasets/valid_set.seg_y.txt'.format(BASE_DIR), help="valid_seg_y_dir")
    ...
    parser.add_argument("--num_to_valid", default=2, help="Number of examples to valid", type=int)
